...
def get_train_args(args: Optional[Dict[str, Any]] = None) -> _TRAIN_CLS:
    ...
    logger.info(f"Generating args: {generating_args}")
    ...
    json.dump(args, open(os.path.join(training_args.output_dir, "training_arguments.json"), "w"), indent=4, ensure_ascii=False)
